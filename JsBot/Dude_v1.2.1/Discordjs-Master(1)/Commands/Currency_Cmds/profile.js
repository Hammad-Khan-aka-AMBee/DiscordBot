...
let lepel = require('../../Database/database/xp.json');
let coin = require('../../Database/database/balance.json');
let reps = require('../../Database/database/rep.json');
let info = require('../../Database/database/note.json');
let bg = require('../../Database/database/background.json');
let fishh = require('../../Database/database/fish.json');
